...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CorelliumClient.TouchInput();
  });
  ...
  describe('TouchInput', function() {
    it('should create an instance of TouchInput', function() {
      // uncomment below and update the code to test TouchInput
      //var instance = new CorelliumClient.TouchInput();
      //expect(instance).to.be.a(CorelliumClient.TouchInput);
    });
