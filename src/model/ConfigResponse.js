...
class ConfigResponse {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('networkTypes')) {
                obj['networkTypes'] = ApiClient.convertToType(data['networkTypes'], ['String']);
            }
    ...
    static validateJSON(data) {
        ...
        if (!Array.isArray(data['networkTypes'])) {
            throw new Error("Expected the field `networkTypes` to be an array in the JSON data but got " + data['networkTypes']);
        }
...
/**
 * Valid network types (e.g. \"nat\", \"bridged\", \"routed\")
 * @member {Array.<String>} networkTypes
 */
ConfigResponse.prototype['networkTypes'] = undefined;

/**
 * Current network type setting
 * @member {String} networkType
 */
ConfigResponse.prototype['networkType'] = undefined;
