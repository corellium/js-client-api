...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CorelliumClient.AgentError();
  });
  ...
  describe('AgentError', function() {
    it('should create an instance of AgentError', function() {
      // uncomment below and update the code to test AgentError
      //var instance = new CorelliumClient.AgentError();
      //expect(instance).to.be.a(CorelliumClient.AgentError);
    });
