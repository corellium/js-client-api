...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CorelliumClient.ActivityRequest();
  });
  ...
  describe('ActivityRequest', function() {
    it('should create an instance of ActivityRequest', function() {
      // uncomment below and update the code to test ActivityRequest
      //var instance = new CorelliumClient.ActivityRequest();
      //expect(instance).to.be.a(CorelliumClient.ActivityRequest);
    });
