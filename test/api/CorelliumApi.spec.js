...
(function(root, factory) {
  ...
  describe('CorelliumApi', function() {
    ...
    describe('v1GetInstanceRate', function() {
      it('should call v1GetInstanceRate successfully', function(done) {
        //uncomment below and update the code to test v1GetInstanceRate
        //instance.v1GetInstanceRate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
