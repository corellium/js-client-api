...
class InstanceCreateOptions {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('wanAccess')) {
                obj['wanAccess'] = ApiClient.convertToType(data['wanAccess'], 'Boolean');
            }
        }
        return obj;
    }
 ...
 * @member {Boolean} wanAccess
 */
InstanceCreateOptions.prototype['wanAccess'] = undefined;
