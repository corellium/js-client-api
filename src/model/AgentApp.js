...
class AgentApp {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('bundlePath')) {
                obj['bundlePath'] = ApiClient.convertToType(data['bundlePath'], 'String');
            }
            if (data.hasOwnProperty('bundleDataPath')) {
                obj['bundleDataPath'] = ApiClient.convertToType(data['bundleDataPath'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        // ensure the json data is a string
        if (data['bundlePath'] && !(typeof data['bundlePath'] === 'string' || data['bundlePath'] instanceof String)) {
            throw new Error("Expected the field `bundlePath` to be a primitive type in the JSON string but got " + data['bundlePath']);
        }
        // ensure the json data is a string
        if (data['bundleDataPath'] && !(typeof data['bundleDataPath'] === 'string' || data['bundleDataPath'] instanceof String)) {
            throw new Error("Expected the field `bundleDataPath` to be a primitive type in the JSON string but got " + data['bundleDataPath']);
        }
...
/**
 * 
 * @member {String} bundlePath
 */
AgentApp.prototype['bundlePath'] = undefined;

/**
 * 
 * @member {String} bundleDataPath
 */
AgentApp.prototype['bundleDataPath'] = undefined;
