...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CorelliumClient.InstallFirmwareAssetsResponse();
  });
  ...
  describe('InstallFirmwareAssetsResponse', function() {
    it('should create an instance of InstallFirmwareAssetsResponse', function() {
      // uncomment below and update the code to test InstallFirmwareAssetsResponse
