...
import InstanceNetdumpState from './InstanceNetdumpState';
...
class Instance {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('netdump')) {
                obj['netdump'] = InstanceNetdumpState.constructFromObject(data['netdump']);
            }
    ...
    static validateJSON(data) {
        ...
        if (data['services']) { // data not null
          InstanceServices.validateJSON(data['services']);
        }
        // ensure the json data is a string
        ...
        if (data['agent']) { // data not null
          InstanceAgentState.validateJSON(data['agent']);
        }
        // validate the optional field `netmon`
        if (data['netmon']) { // data not null
          InstanceNetmonState.validateJSON(data['netmon']);
        }
        // validate the optional field `netdump`
        if (data['netdump']) { // data not null
          InstanceNetdumpState.validateJSON(data['netdump']);
        }
        // ensure the json data is a string
        ...
        if (data['createdBy']) { // data not null
          CreatedBy.validateJSON(data['createdBy']);
        }
...
/**
 * Secondary Interface LAN IP Address (if supported)
