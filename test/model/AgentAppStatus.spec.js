...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CorelliumClient.AgentAppStatus();
  });
  ...
  describe('AgentAppStatus', function() {
    it('should create an instance of AgentAppStatus', function() {
      // uncomment below and update the code to test AgentAppStatus
      //var instance = new CorelliumClient.AgentAppStatus();
      //expect(instance).to.be.a(CorelliumClient.AgentAppStatus);
    });
