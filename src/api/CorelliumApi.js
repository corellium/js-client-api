...
export default class CorelliumApi {
    ...
    */
     ...
     * @param {String} instanceId Instance ID - uuid
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/RateInfo} and HTTP response
     */
    v1GetInstanceRateWithHttpInfo(instanceId) {
      let postBody = null;
      // verify the required parameter 'instanceId' is set
      if (instanceId === undefined || instanceId === null) {
        throw new Error("Missing the required parameter 'instanceId' when calling v1GetInstanceRate");
      }
     ...
     * Returns the cost, in microcents, for the instance in the on and off state. Instances are charged $0.25 / day for storage (off) and $0.25 per core per hour (on).
     * @param {String} instanceId Instance ID - uuid
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/RateInfo}
     */
    v1GetInstanceRate(instanceId) {
      return this.v1GetInstanceRateWithHttpInfo(instanceId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    v1InstancesInstanceIdMessagePostWithHttpInfo(instanceId) {
      let postBody = null;
      // verify the required parameter 'instanceId' is set
      if (instanceId === undefined || instanceId === null) {
    ...
    v1InstancesInstanceIdMessagePost(instanceId) {
      return this.v1InstancesInstanceIdMessagePostWithHttpInfo(instanceId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    v1RestoreBackupWithHttpInfo(instanceId) {
      let postBody = null;
      // verify the required parameter 'instanceId' is set
      if (instanceId === undefined || instanceId === null) {
    ...
    v1RestoreBackup(instanceId) {
      return this.v1RestoreBackupWithHttpInfo(instanceId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
